...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mmc_fos_user_bundle.sonata_admin.template' => 'getMmcFosUserBundle_SonataAdmin_TemplateService',
            'mmc_fos_user_bundle.sonata_admin.user' => 'getMmcFosUserBundle_SonataAdmin_UserService',
            'mmcfosuserbundle.password_resetting' => 'getMmcfosuserbundle_PasswordResettingService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('n-s5w7Ujw8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SJCVABCIov', 0, '3q4Y+gH1ugJcf1KGf1QTQq', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OiARXLTc2a', 0, '3q4Y+gH1ugJcf1KGf1QTQq', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TO1OcHC1J3', 0, '3q4Y+gH1ugJcf1KGf1QTQq', (__DIR__.'/pools'), $a));
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/srv/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator.default')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, '/srv/app', array())), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('mmcfosuserbundle.password_resetting', 'MMC\\FosUserBundle\\EventListener\\PasswordResettingListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'database', 'port' => NULL, 'dbname' => 'oauth', 'user' => 'root', 'password' => 'oauth', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 10.0, 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Entity')), 'MMC\\FosUserBundle\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/srv/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine-mapping' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MMCFosUserBundle' => 'MMC\\FosUserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_35ce9fef132c50da6b7b17d0bc84a984fd29ee56f40cd1cf7ad0f838a12223e9');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/srv/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MMC\\FosUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MMC\\FosUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MMC\\FosUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MMC\\FosUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'MMC\\FosUserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'mmc_fos_user_bundle.sonata_admin.template' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MMC\FosUserBundle\Block\UserBlock A MMC\FosUserBundle\Block\UserBlock instance
     */
    protected function getMmcFosUserBundle_SonataAdmin_TemplateService()
    {
        return $this->services['mmc_fos_user_bundle.sonata_admin.template'] = new \MMC\FosUserBundle\Block\UserBlock('mmc_fos_user_bundle.sonata_admin.template', $this->get('templating'));
    }

    /**
     * Gets the 'mmc_fos_user_bundle.sonata_admin.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MMC\FosUserBundle\Admin\UserAdmin A MMC\FosUserBundle\Admin\UserAdmin instance
     */
    protected function getMmcFosUserBundle_SonataAdmin_UserService()
    {
        $this->services['mmc_fos_user_bundle.sonata_admin.user'] = $instance = new \MMC\FosUserBundle\Admin\UserAdmin(NULL, 'MMC\\FosUserBundle\\Entity\\User', NULL);

        $instance->setTranslationDomain('UserAdmin');
        $instance->setUserManager($this->get('fos_user.user_manager'));
        $instance->setRoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
        $instance->setRolesAvailables(array());

        return $instance;
    }

    /**
     * Gets the 'mmcfosuserbundle.password_resetting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MMC\FosUserBundle\EventListener\PasswordResettingListener A MMC\FosUserBundle\EventListener\PasswordResettingListener instance
     */
    protected function getMmcfosuserbundle_PasswordResettingService()
    {
        return $this->services['mmcfosuserbundle.password_resetting'] = new \MMC\FosUserBundle\EventListener\PasswordResettingListener($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        $r->setOptions(array('default_target_path' => '/admin', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $t = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, $i, $p, 'main', $r, $s, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager'));
        $t->setRememberMeServices($f);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c, $d), 2 => $q, 3 => $t, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $f, $h, $a, $c, true, $i), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '587f7db8abb4d7.73729842', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $o, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $p, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $p, '/login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/srv/app/../var/sessions/dev');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('sl' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 'en' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf', 3 => '/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Resources/translations/FOSUserBundle.en.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml', 5 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 'bg' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 'fa' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 'no' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf'), 'fi' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 'mn' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf'), 'zh_TW' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf'), 'el' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 'cy' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf'), 'id' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 'ar' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 'lt' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml'), 'ca' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml'), 'da' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml'), 'sr_Cyrl' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf'), 'sr_Latn' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 'hr' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 'hy' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf'), 'ru' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 'af' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf', 1 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.af.yml'), 'tr' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 'nl' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 'it' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 'ro' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml'), 'pl' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 'nn' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf'), 'lb' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml'), 'sv' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 'pt_BR' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml'), 'vi' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 'sk' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 'hu' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml'), 'az' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf'), 'gl' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf'), 'es' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 'et' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml'), 'fr' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf', 3 => '/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Resources/translations/FOSUserBundle.fr.yml', 4 => '/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Resources/translations/UserAdmin.fr.xliff', 5 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml', 6 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 'th' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 'eu' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 'sq' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf'), 'pt' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 'he' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 'cs' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 'uk' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf', 2 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 'ja' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml'), 'lv' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml'), 'zh_CN' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 'de' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf', 1 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf', 2 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf', 3 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml', 4 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 'pt_PT' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf'), 'ua' => array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf'), 'nb' => array(0 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml', 1 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 'ky' => array(0 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ky.yml', 1 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ky.yml'))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/srv/app', 'UTF-8'));
        ...
        $instance->addGlobal('mmc_fos_user_layout', 'FOSUserBundle:Default:layout.html.twig');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        ...
        $instance->addPath('/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Resources/views', 'MMCFosUser');
        $instance->addPath('/srv/vendor/meuhmeuhconcept/fos-user-bundle/src/Resources/views', 'FOSUser');
        $instance->addPath('/srv/vendor/friendsofsymfony/user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views', 'Debug');
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/srv/app/Resources/views');
        $instance->addPath('/srv/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f809646e03dd490672d237a533dd35a1a2732144');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/srv/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/srv/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml'));
        ...
        $instance->addXmlMapping('/srv/vendor/friendsofsymfony/user-bundle/DependencyInjection/Compiler/../../Resources/config/storage-validation/orm.xml');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MMCFosUserBundle' => 'MMC\\FosUserBundle\\MMCFosUserBundle',
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle',
                ...
                'AppBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/src/AppBundle',
                    'namespace' => 'AppBundle',
                ),
                'MMCFosUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => '/srv/vendor/meuhmeuhconcept/fos-user-bundle/src',
                    'namespace' => 'MMC\\FosUserBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/friendsofsymfony/user-bundle',
                    'namespace' => 'FOS\\UserBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ),
                'WebProfilerBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ),
                'SensioDistributionBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/sensio/distribution-bundle',
                    'namespace' => 'Sensio\\Bundle\\DistributionBundle',
                ),
                'SensioGeneratorBundle' => array(
                    'parent' => NULL,
                    'path' => '/srv/vendor/sensio/generator-bundle',
            ...
            'database_name' => 'oauth',
            'database_user' => 'root',
            'database_password' => 'oauth',
            'database_server_version' => 10.0,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'f809646e03dd490672d237a533dd35a1a2732144',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f809646e03dd490672d237a533dd35a1a2732144',
            ...
            'session.save_path' => '/srv/app/../var/sessions/dev',
            ...
            'router.resource' => '/srv/app/config/routing_dev.yml',
            ...
            'mmc_fos_user_bundle.roles.availables' => array(
            ...
            'fos_user.model.user.class' => 'MMC\\FosUserBundle\\Entity\\User',
